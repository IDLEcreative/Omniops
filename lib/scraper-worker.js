...
function extractMetadata(document) {
  ...
  const { price: prodPrice, sku: prodSku, inStock, categories, availability: prodAvailability, extractedAt, ...otherProductData } = productData;
  ...
  return {
    ...
    // ONLY use consolidated field names
