        ...
        try {
          ...
          try {
            ...
            if (ecommerceExtracted?.products?.length > 0) {
              ...
              console.log(`[Worker ${jobId}] Product:`, {
            ...
            const dbRecord = {
              ...
              metadata: {
                ...
                ...(pageData.ecommerceData?.products?.[0] && {
                  // Add top-level product metadata for easier querying
                  productName: pageData.ecommerceData.products[0].name,
                  productSku: pageData.ecommerceData.products[0].sku,
            ...
            if (pageError) {
              ...
              if (FORCE_RESCRAPE) {
                console.log(`[Worker ${jobId}] Force rescrape metadata for ${pageUrl}:`, {
                  price: dbRecord.metadata?.productPrice,
                  availability: dbRecord.metadata?.productInStock,
                  sku: dbRecord.metadata?.productSku,
