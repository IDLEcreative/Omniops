/**
 * Parser utilities for extracting specific product data
 */

import * as cheerio from 'cheerio';
import { ProductData } from './types';
import { priceSelectors } from './selectors';

/**
 * Extract product data from JSON-LD structured data
 */
export function extractFromJsonLd($: cheerio.CheerioAPI, productData: ProductData): void {
 ...
 */
export function extractPriceData($: cheerio.CheerioAPI, productData: ProductData): void {
 ...
 */
export function extractProductImages($: cheerio.CheerioAPI, productData: ProductData): void {
