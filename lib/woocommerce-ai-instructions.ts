/**
 * Enhanced AI instructions for WooCommerce integration
 * These instructions ensure the AI properly uses customer data
 */

export class WooCommerceAIInstructions {
  /**
