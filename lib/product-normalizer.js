...
class ProductNormalizer {
    ...
    static normalizePrice(priceText, currency) {
        ...
        // If it's already a normalized price object, return as is
        if (typeof priceText === 'object' && priceText.value !== undefined) {
            return priceText;
        }
    ...
    static normalizeAvailability(text) {
        ...
        // If it's already a normalized availability object, return as is
        if (typeof text === 'object' && text.inStock !== undefined) {
            return text;
        }
