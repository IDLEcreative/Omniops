...
class BusinessClassifier {
     ...
     */
    static async classifyBusiness(domain, sampleContent, metadata) {
        ...
        const bestMatch = classifications.reduce((best, current) => current.confidence > best.confidence ? current : best);
    ...
    static checkEcommerce(content, metadata) {
        const indicators = [];
        let score = 0;
        // Strong indicators
    ...
    static checkRealEstate(content, metadata) {
        const indicators = [];
        let score = 0;
        // Strong indicators
    ...
    static checkHealthcare(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static checkLegal(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static checkEducation(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static checkRestaurant(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static checkAutomotive(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static checkFinancial(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static checkHospitality(content, metadata) {
        const indicators = [];
        let score = 0;
    ...
    static getProfessionalServicesClassification(content) {
        return {
