...
exports.URLDeduplicator = void 0;
class URLDeduplicator {
     ...
     */
    isExcluded(url, excludePatterns = []) {
     ...
     */
    filterUrls(urls, excludePatterns = []) {
        return urls.filter(url => !this.hasProcessed(url) &&
     ...
     */
    findSimilarUrls(url, threshold = 0.8) {
...
exports.URLDeduplicator = URLDeduplicator;
