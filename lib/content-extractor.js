...
const business_content_extractor_1 = require("./business-content-extractor");
...
function htmlToText(html) {
    return (0, business_content_extractor_1.smartHtmlToText)(html);
}
...
function stripBoilerplate(document) {
    ...
    (0, business_content_extractor_1.selectiveStripBoilerplate)($);
...
class ContentExtractor {
    ...
    static extractWithReadability(html, url) {
        ...
        const businessInfo = (0, business_content_extractor_1.extractBusinessInfo)(html);
        // Create virtual DOM
        ...
        const reader = new readability_1.Readability(documentClone);
