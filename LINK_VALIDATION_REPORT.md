...
- **Line 575:** `/app/api/scrape-jobs/README.md`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 464:** `/app/api/scrape-jobs/next/README.md`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 12:** `#standard-release-deployment`
  - Reason: Anchor not found in source file
  - Link text: "Anchor not found in source file"
...
- **Line 1110:** `../lib/embeddings-functions.ts`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 21:** `#debugging--investigation-tools`
  - Reason: Anchor not found in source file
  - Link text: "Anchor not found in source file"
...
- **Line 89:** `PULL_REQUEST_TEMPLATE.md`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 94:** `docs/WOOCOMMERCE_API_KEY_REGENERATION.md`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 228:** `__tests__/lib/link-sanitizer.test.ts`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 38:** `file://__tests__/api/chat/route-async.test.ts`
  - Reason: File not found
  - Link text: "File not found"
...
- **Line 178:** `file://__tests__/api/gdpr/`
  - Reason: File not found
  - Link text: "File not found"
...
- /docs/SECURITY_HARDENING_SUMMARY.md:249

### docs.anthropic.com (1)

- /MCP_SETUP_GUIDE.md:316

### example.com (10)

- /components/chat/README.md:60
- /docs/BOT_LINK_EXAMPLES.md:10
- /docs/BOT_LINK_EXAMPLES.md:15
- /docs/BOT_LINK_EXAMPLES.md:20
- /docs/BOT_LINK_EXAMPLES.md:20
- /docs/BOT_LINK_EXAMPLES.md:28
- /docs/ENABLING_BOT_LINKS.md:110
- /docs/ENABLING_BOT_LINKS.md:148
...
- /docs/DATABASE_OPTIMIZATION.md:222
...
- /components/chat/README.md:190
- /components/chat/README.md:220

### html.spec.whatwg.org (1)

- /docs/STREAMING_FUTURE_FEATURE.md:559

### jestjs.io (4)

- /docs/ISSUE_MSW_TEST_PERFORMANCE.md:368
- /docs/TESTING_QUICKSTART.md:168
- /docs/TESTING_SUPABASE_ROUTES.md:406
- /docs/TESTING.md:342

### keepachangelog.com (2)

- /CHANGELOG.md:7
- /DOCUMENTATION_VERSION_TRACKING_SUMMARY.md:384
...
- /docs/SETUP_GUIDE.md:83
- /docs/SETUP_GUIDE.md:87
- /docs/SETUP_GUIDE.md:88
- /docs/SETUP_GUIDE.md:89
...
- /MCP_SETUP_GUIDE.md:315

### mswjs.io (4)

- /docs/ISSUE_MSW_TEST_PERFORMANCE.md:367
- /docs/TESTING_QUICKSTART.md:170
- /docs/TESTING_SUPABASE_ROUTES.md:407
- /docs/TESTING.md:344
...
- /docs/NEWSLETTER_AI_PRODUCTIVITY.md:297
...
- /docs/STREAMING_FUTURE_FEATURE.md:558

### postgresql.org (1)

- /docs/06-TROUBLESHOOTING/README.md:1683
...
- /docs/STREAMING_FUTURE_FEATURE.md:560

### semver.org (2)

- /CHANGELOG.md:8
- /DOCUMENTATION_VERSION_TRACKING_SUMMARY.md:383
...
- /docs/STYLING_GUIDE.md:118

### testing-library.com (2)

- /docs/TESTING_QUICKSTART.md:169
- /docs/TESTING.md:343

### ui.shadcn.com (1)

- /docs/STYLING_GUIDE.md:117
...
- /docs/reports/chat-analysis-report.md:126
- /docs/reports/chat-category-analysis-final-report.md:90
- /docs/reports/chat-category-analysis-final-report.md:91
- /docs/reports/chat-category-analysis-final-report.md:92
...
- /DOCUMENTATION_VERSION_TRACKING_SUMMARY.md:385
