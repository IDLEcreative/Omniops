 ...
 * Tests that staging domain can access production content through domain mapping
 */

async function testStagingChat() {
  console.log('🧪 Testing Thompson\'s staging domain chat functionality...\n');

  const testUrl = 'https://www.omniops.co.uk/api/chat';
...
// Run the test
testStagingChat().catch(console.error);