...
import {
  ...
  createAbortError,
  createDelayedFetchResponse
} from './use-dashboard-overview.test-utils';
import { TestComponent } from './use-dashboard-overview.test-component';
...
describe('useDashboardOverview', () => {
  ...
  it('handles empty trend data and recent conversations', async () => {
    const mockData = createMockOverview({ trend: [], recentConversations: [] });
    (global.fetch as jest.Mock).mockImplementation(() => createFetchResponse(mockData));
  ...
  it('maintains loading state during refresh', async () => {
    const mockData = createMockOverview();
    const delayed = createDelayedFetchResponse(mockData);
