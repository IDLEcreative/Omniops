 ...
 *
 * FIXED: Infinite loop issue resolved by using useRef in useParentCommunication hook.
 * The handleMessage callback now accesses conversationId/isOpen/sessionId via refs
 * instead of including them in the dependency array, preventing the infinite loop.
 */
