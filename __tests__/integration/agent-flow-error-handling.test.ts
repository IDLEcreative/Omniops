...
// NOTE: These tests require localhost:3000 to be running
// Skipped by default via SKIP_E2E env var (set to false to run: SKIP_E2E=false npm test)
// CI environments automatically skip E2E tests
