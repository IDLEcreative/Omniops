  ...
  },
  {
    ...
    checkForHallucination: (response) => {
      ...
      const suggestsSpecificAlternative =
        lower.includes('you can use') || lower.includes('alternative is') || lower.includes('replacement');
  ...
  },
  {
    ...
    checkForHallucination: (response) => {
      ...
      const refersToContact =
        lower.includes('contact') || lower.includes('quote') || lower.includes('sales team');
