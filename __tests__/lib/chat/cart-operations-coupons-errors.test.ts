/**
 * Cart Operations Tests: Coupon Application - Errors & Edge Cases
 *
 * Tests coupon error scenarios including expired coupons, usage limits,
 * minimum order amounts, and multiple coupons.
 *
 * REVENUE-CRITICAL: Coupon errors must be handled correctly to prevent
 * incorrect discounts or customer confusion.
 */
...
describe('Cart Operations - Coupon Application: Errors & Edge Cases', () => {
  ...
  describe('applyCouponToCartDirect - Coupon Restrictions', () => {
  ...
  describe('applyCouponToCartDirect - Multiple Coupons & Exceptions', () => {
